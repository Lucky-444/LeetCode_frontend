...
const SignupSchema = z.object({
  firstName: z.string().min(2 , { message: "First name must be at least 2 characters long" }).max(100).nonempty(),
      ...
      <div className="card w-full max-w-md shadow-xl bg-base-100 relative z-10">
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            <Link to="/login" className="text-center text-sm  text-underline hover:text-gray-700 ">Already have an account? Log in</Link>
          </form>
        </div>
      </div>
    </div>
